...
st.image("2026_Players.jpeg", width=480) 
        ...
        if challenge_selection == "Season Ball Challenge":
            ...
            with st.expander("Full Rules and Examples", expanded=False):
                st.markdown(
                    ...
                    "- If a ball becomes crack and unplayable, play your next ball and at the end of the round return the crack ball for a replacement. Scuff balls does not count as crack and keep playing until lost.\n"
                    "- If you miss more than 50% of play, at end of season you return the ball from your first sleeve. Your prize tier will be the second tier.\n"
                    "- If you miss more than 50% of play, after REBUY 1, at end of season you return the ball from your REBUY 1. Your prize tier will be the third tier.\n"
                    "- If you miss more than 50% of play, after REBUY 2, at end of season you return the ball from your REBUY 2. Your prize tier will be the fourth tier.\n\n"
                    "**Examples**\n\n"
