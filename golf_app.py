...
with tabs[3]:  # GGG Challenge
    ...
    with col_main:
        if challenge_selection == "Season Ball Challenge":
            ...
            st.markdown("""**Overview:** Use your Gold Card to play from the front tees. To avoid the penalty, you must finish first overall that week. If not, you owe at least $100 worth of food for the end‑of‑year GGGolf Picnic or $100 to GGGolf.  
                        Example: Dale turns his gold card in, Dale plays from the Gold, Dale finish 2nd overall, no handicap used all others scores are handicap. Dale will owe 4 ducks to the picnic
