...
with tab1:
    ...
    # Only show/enable submit button if authenticated
    if st.session_state["authenticated"]:
        ...
        st.button("Submit Score", use_container_width=True, disabled=True)
...
with tab4:
    ...
    * **No Animal Bets:** Bet your Bets, Drink your bets.
    * **No Animal Bay Etiquette:** After hitting, return ball to hitting area for next player. Failure to do so results in 1/4 drink.
    * **First Putt:** Player makes first putt in-hole = Everyone on that bay drinks 1/4. 
    * **Chips:** Player chips in-hole = Everyone on that bay drinks drinks 1/2. 
    * **Mulligans:** Owe 1 a bucket right away.
    """)
