...
with tabs[3]:  # GGG Challenge
    ...
    with col_main:
        if challenge_selection == "Season Ball Challenge":
            ...
            st.markdown("**Entry:** Use your Gold Ticket to play from the front tees. To avoid the penalty, you must finish first overall that week. If not, you owe at least $100 worth of food for the end‑of‑year GGGolf Picnic or $100 to GGGolf. Note: The Gold Ticket cannot be used at Currie Golf Course or during GGGOLF events.
")
